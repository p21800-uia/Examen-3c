...
public class Principal {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SolicitudRetiroMaterial solicitudRetiro = gestorRetiro.agregaSolicitudSalidaMaterial(
                "SolicitudRetiroMaterial",
                "Alfonso ",
                "Profesor TSU");

        solicitudRetiro.agrega("100","Material Oficina", "110","Sillas","111","Silla ejecutiva clase 1", lote1, 2);
        solicitudRetiro.agrega("100","Material Oficina","110","Sillas","113","Silla secretarial clase 1", lote3, 3);
        solicitudRetiro.agrega("100","Material Oficina","110","Sillas","115","Silla de espera ", lote5, 4);
        solicitudRetiro.agrega("100","Material Oficina", "130","Escritorios","131","Escritorio ejecutiva clase 1", lote7, 2);
        solicitudRetiro.agrega("100","Material Oficina","130","Escritorios","133","Escritorio secretarial clase 1", lote9, 3);
        solicitudRetiro.agrega("100","Material Oficina","130","Escritorios","135","Escritorio de espera ", lote11, 4);
        ...
        gestorRetiro.cargaSolicitudRetiro("SolicitudRetiroMaterial_1.json");   // Esta es la solicitud o archivo fuente o documento que se quiere agregar o que se usa para actualizar
        gestorRetiro.cargaInventario("ReporteNivelInventario-13.json");   // Este es documento objetivo.. el que quieren actualizar
        //gestorRetiro.cargaSolicitudRetiroToInventario();
        //gestorRetiro.serializaNivelInventario("ReporteNivelInventario-13.json");
