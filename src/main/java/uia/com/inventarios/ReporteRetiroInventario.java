...
public class ReporteRetiroInventario implements IRetiroInventario
{
    ...
    public void cargaSolicitudRetiro(String nombre)
    {
        ...
        try {
            ...
            sem =  mapper.readValue(new FileInputStream(nombre), SolicitudRetiroMaterial.class );
