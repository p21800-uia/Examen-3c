...
public class SolicitudRetiroMaterial extends RegistroItem implements IRetiroInventario
{
    private String id="";
    ...
    public SolicitudRetiroMaterial()
    {
    }

    public SolicitudRetiroMaterial(NivelInventario inventario, String id, String solicitante, String categoria)
    {
    ...
    public void serializa(SolicitudRetiroMaterial sem) throws IOException {
        ObjectMapper mapper = new ObjectMapper();
    ...
    public void agrega(String idPartida, String descPartida, String idSubpartida, String descSubpartida, String idCat, String descCat,
                       Lote lote, int cantidadRetiro)
    {
        InfoItem item;
        item = this.inventario.agrega("Item", idPartida,descPartida, idSubpartida, descSubpartida, idCat, descCat,  lote, cantidadRetiro);
    }
}